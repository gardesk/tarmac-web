...
<div className="screenshot-placeholder">
  <p className="text-lg font-medium mb-2">Screenshot: Scratchpad terminal</p>
  <p className="text-sm">A centered terminal scratchpad overlaying the tiled layout</p>
  <p className="text-xs mt-4 italic">[ placeholder — add scratchpad.png to public/ ]</p>
</div>
