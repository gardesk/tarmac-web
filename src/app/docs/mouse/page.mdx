...
<div className="screenshot-placeholder">
  <p className="text-lg font-medium mb-2">Screenshot: Cmd+drag to move</p>
  <p className="text-sm">A floating window being repositioned with Cmd+drag</p>
  <p className="text-xs mt-4 italic">[ placeholder — add cmd-drag.png to public/ ]</p>
</div>
