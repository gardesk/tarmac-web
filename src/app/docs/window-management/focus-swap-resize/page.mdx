...
<div className="screenshot-placeholder">
  <p className="text-lg font-medium mb-2">Screenshot: Before and after swap</p>
  <p className="text-sm">Two-panel showing a window swap operation</p>
  <p className="text-xs mt-4 italic">[ placeholder — add swap-demo.png to public/ ]</p>
</div>
